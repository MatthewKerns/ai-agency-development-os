...
### High Potential (Could collaborate)
- [Name] - [Audience size] - [Why good fit] - [Next step]

### Moderate (Keep warm)
- [Name] - [Audience size] - [Why potentially valuable]
...
**"I need to learn about [topic]"** → Check by-expertise.md
**"Who has audience in [niche]?"** → Check audience overlap above
**"Best YouTube channels to follow?"** → Check by-platform.md
